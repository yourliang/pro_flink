...
public class KafkaSinkDemo {
    public static void main(String[] args) throws Exception {
        ...
        props.setProperty("group.id", "console-consumer-95858");//消费者组id
        ...
        FlinkKafkaConsumer<String> kafkaSource = new FlinkKafkaConsumer<String>("cube_topic-zwdc-zwdc_product_export_record_log", new SimpleStringSchema(), props);
        //使用kafkaSource
